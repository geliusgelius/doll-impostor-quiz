...
export function MaterialSymbolsHouseOutline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M5 20v-9.15L2.2 13L1 11.4L12 3l4 3.05V4h3v4.35l4 3.05l-1.2 1.6l-2.8-2.15V20h-6v-6h-2v6zm2-2h2v-6h6v6h2V9.325l-5-3.8l-5 3.8zm3-7.975h4q0-.8-.6-1.313T12 8.2t-1.4.513t-.6 1.312M9 18v-6h6v6v-6H9z"
      />
    </svg>
  );
}

export function IconParkOutlineCircus(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      ...
      >
        ...
        <path
          strokeLinejoin="round"
          d="M6 18s7.592-.055 11-1c2.866-.795 7-3 7-3s3.823 2.194 6.5 3c3.572 1.075 11.5 1 11.5 1l-1 7s-4 2-5 2s-3-2-4-2s-3.5 3-4 3s-3-3-4-3s-3 3.5-4 3.5s-3-3.5-4-3.5c-.198 0-.474.078-.79.204c-2.142.852-4.489 1.284-6.629.428L7 25z"
        />
        <path d="M24 5v10" />
        <path
          strokeLinejoin="round"
          d="M36 11V5s-1.5 3-6 0s-6 0-6 0v6s1.5-3 6 0s6 0 6 0"
        />
      </g>
    </svg>
  );
...
export function MdiPineTreeVariantOutline(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M19 12L12 2L5 12h1.86L3 18h7v4h4v-4h7l-3.86-6zm-3.84-2H13.5l3.84 6H6.67l3.86-6H8.84L12 5.5z"
      />
    </svg>
  );
}
